...
import { Bug, ChevronRight, HelpCircle, Moon, Settings, ShieldCheck, Sun } from 'lucide-react-native';
          ...
          {onOpenSettings ? (
            <TouchableOpacity style={styles.toggleCard} onPress={onOpenSettings} activeOpacity={0.7} testID="profile-open-settings">
              ...
              <View style={styles.toggleTextWrap}>
                ...
                <Text style={styles.toggleSubtitle}>Notifications, haptics, and data management.</Text>
              </View>
              <ChevronRight color={theme.textSecondary} size={18} strokeWidth={2.3} />
            </TouchableOpacity>
          ) : null}

...
const createStyles = (theme: Theme, isDark: boolean, width: number) => {
  ...
  return StyleSheet.create({
    ...
    leaderboardButton: {
      ...
      backgroundColor: isDark ? 'rgba(15, 23, 42, 0.9)' : 'rgba(255, 255, 255, 0.97)',
      shadowColor: '#000',
    ...
    toggleCard: {
      ...
      borderRadius: 24,
      borderWidth: 1,
      borderColor: isDark ? 'rgba(99, 102, 241, 0.22)' : 'rgba(148, 163, 184, 0.18)',
      backgroundColor: isDark ? 'rgba(9, 15, 30, 0.9)' : 'rgba(248, 250, 252, 0.95)',
      shadowColor: '#000',
    ...
    toggleChevronWrap: {
      ...
      borderWidth: 1,
      borderColor: isDark ? 'rgba(148, 163, 184, 0.1)' : 'rgba(148, 163, 184, 0.12)',
    },
    heroCard: {
      borderRadius: 24,
      overflow: 'hidden',

...
function computeLevelProgress(totalXp: number): { current: number; required: number; percent: number } {
  let threshold = 0;
  let cost = 200;
  ...
  return {
    current,
    required: cost,
    percent: Math.min(current / cost, 1),
  };
}
...
export default function ProfilePage() {
  ...
  const achievements: AchievementItem[] = useMemo(() => [
    ...
    },
    {
      ...
      xp: 75,
      progress: Math.min(stats.totalCardsStudied, 50),
      total: 50,
      color: '#4ECDC4',
      icon: BookOpen,
    },
    {
      id: 'card_cruncher',
      name: 'Card Cruncher',
      description: 'Study 250 flashcards',
      xp: 150,
      progress: Math.min(stats.totalCardsStudied, 250),
      total: 250,
      color: '#4ECDC4',
      icon: BookOpen,
    },
    {
      id: 'study_machine',
      name: 'Study Machine',
      description: 'Study 1,000 flashcards',
      xp: 400,
      progress: Math.min(stats.totalCardsStudied, 1000),
      total: 1000,
      color: '#4ECDC4',
      icon: BookOpen,
    },
    {
      ...
      description: 'Study 5,000 flashcards',
      xp: 1000,
      progress: Math.min(stats.totalCardsStudied, 5000),
      total: 5000,
      color: '#4ECDC4',
      icon: BookOpen,
    },
    ...
    },
    {
      ...
      xp: 2000,
      progress: Math.min(stats.longestStreak, 60),
      total: 60,
      color: '#B91C1C',
      icon: Flame,
    },
    {
      ...
      xp: 50,
      progress: Math.min(stats.totalScore, 500),
      total: 500,
      color: '#F093FB',
      icon: Crown,
    },
    {
      ...
      xp: 150,
      progress: Math.min(stats.totalScore, 2500),
      total: 2500,
      color: '#D946EF',
      icon: Crown,
    },
    ...
    },
    {
      ...
      xp: 1000,
      progress: Math.min(stats.totalScore, 50000),
      total: 50000,
      color: '#7C3AED',
      icon: Crown,
    },
    ...
    },
    {
      id: 'arena_regular',
      name: 'Arena Regular',
      description: 'Complete 5 arena battles',
      xp: 100,
      progress: Math.min(leaderboard.length, 5),
      total: 5,
      color: '#F59E0B',
      icon: Award,
    },
    {
      ...
      description: 'Complete 25 arena battles',
      xp: 300,
      progress: Math.min(leaderboard.length, 25),
      total: 25,
      color: '#D97706',
      icon: Award,
    },
    {
      id: 'arena_veteran',
      name: 'Arena Veteran',
      description: 'Complete 50 arena battles',
      xp: 750,
      progress: Math.min(leaderboard.length, 50),
      total: 50,
      color: '#B45309',
      icon: Award,
    },
    {
      id: 'sharp_eye',
      name: 'Sharp Eye',
      description: 'Get a 3-answer streak in Quest mode',
      xp: 50,
      progress: Math.min(performance.bestQuestStreak, 3),
      total: 3,
      color: '#6366F1',
      icon: Zap,
    },
    {
      id: 'hot_hands',
      name: 'Hot Hands',
      description: 'Get a 7-answer streak in Quest mode',
      xp: 150,
      progress: Math.min(performance.bestQuestStreak, 7),
      total: 7,
      color: '#6366F1',
      icon: Zap,
    },
    {
      id: 'flawless_run',
      name: 'Flawless Run',
      description: 'Get a 12-answer streak in Quest mode',
      xp: 400,
      progress: Math.min(performance.bestQuestStreak, 12),
      total: 12,
      color: '#4F46E5',
      icon: Zap,
    },
    {
      id: 'perfect_mind',
      name: 'Perfect Mind',
      description: 'Get a 20-answer streak in Quest mode',
      xp: 1000,
      progress: Math.min(performance.bestQuestStreak, 20),
      total: 20,
      color: '#4338CA',
      icon: Zap,
    },
    ...
    },
    {
      ...
      xp: 50,
      progress: Math.min(customDeckCount, 1),
      total: 1,
      color: '#14B8A6',
      icon: BookOpen,
    },
    {
      id: 'deck_architect',
      name: 'Deck Architect',
      description: 'Create 3 custom decks',
      xp: 100,
      progress: Math.min(customDeckCount, 3),
      total: 3,
      color: '#0D9488',
      icon: BookOpen,
    },
    {
      ...
      xp: 300,
      progress: Math.min(customDeckCount, 10),
      total: 10,
      color: '#0F766E',
      icon: BookOpen,
    },
    {
      id: 'starter_pack',
      name: 'Starter Pack',
      description: 'Own 25 flashcards across all decks',
      xp: 25,
      progress: Math.min(totalCardsOwned, 25),
      total: 25,
      color: '#667EEA',
      icon: BookOpen,
    },
    {
      ...
      description: 'Own 100 flashcards across all decks',
      xp: 75,
      progress: Math.min(totalCardsOwned, 100),
      total: 100,
      color: '#667EEA',
      icon: BookOpen,
    },
    {
      id: 'card_hoarder',
      name: 'Card Hoarder',
      description: 'Own 250 flashcards across all decks',
      xp: 200,
      progress: Math.min(totalCardsOwned, 250),
      total: 250,
      color: '#4F46E5',
      icon: BookOpen,
    },
    {
      ...
      description: 'Own 500 flashcards across all decks',
      xp: 400,
      progress: Math.min(totalCardsOwned, 500),
      total: 500,
      color: '#4338CA',
      icon: BookOpen,
    },
    {
      ...
      description: 'Own 1,000 flashcards across all decks',
      xp: 1000,
      progress: Math.min(totalCardsOwned, 1000),
      total: 1000,
      color: '#3730A3',
      icon: BookOpen,
    },
